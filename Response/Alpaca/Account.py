...
class Account(object):
    def __init__(self, account_blocked, account_number, buying_power, cash, created_at,
        ...
        self.daytrade_count = int(daytrade_count)  # string<int>
        self.daytrading_buying_power = float(daytrading_buying_power)  # string<number>
        self.equity = float(equity)  # string<number>
        self.id = id  # string<uuid>
        self.initial_margin = float(initial_margin)  # string<number>
        self.last_equity = float(last_equity)  # string<number>
        self.last_maintenance_margin = float(last_maintenance_margin)  # string<number>
        self.long_market_value = float(long_market_value)  # string<number>
        self.maintenance_margin = float(maintenance_margin)  # string<number>
        self.multiplier = float(multiplier)  # string<number>
        self.pattern_day_trader = bool(pattern_day_trader)  # boolean
        self.portfolio_value = float(portfolio_value)  # string<number>
        self.regt_buying_power = float(regt_buying_power)  # string<number>
        self.short_market_value = float(short_market_value)  # string<number>
        self.shorting_enabled = bool(shorting_enabled)  # boolean
        self.sma = float(sma)  # string<number>
